...
In this assignment, you'll create one of two possible computer games - the specifications are below. These apps will run in the browser, and feature dynamically updated HTML and CSS powered by your JavaScript code.
...
1. Create a new GitHub repo with an appropriate title - be creative - don't just name it [Unit3Homework], in accordance with the assignment you choose to complete. Then, clone it to your computer.
...
6. Choose whichever game you'd like to build. Making the easier game will prove less challenging than coding the recommended game. However, as the challenge of the recommended exercise provides a more comprehensive review of this unit's material, we suggest attempting that assignment first.

7. Note: There's no shame if you'd prefer submitting the easier assignment — it's still a proper challenge.

8. Push your selected game to Github Pages.

## Option One (Recommended)

> Request: Make a game in which the player has a limited number of chances to correctly choose the letters to guess a randomly chosen word. The game should be themed.

### Example

- 80s theme: words from the 80s, sounds from the 80s, and an 80s aesthetic
- The app choses a word from the list of words
- The user is shown `_` in place of the letters of the word
- The user presses a letter key in an attempt to guess one of the letters
- The user is shown feedback on if the guess is correct or incorrect

1. Choose a theme for your game! In the example, we picked an 80s theme: 80s questions, 80s sound and an 80s aesthetic. You can choose any subject for your theme, though, so be creative!
...
5. Display the total number of correct letters:
...
8. After the user wins/loses, the game should automatically restart in order to allow the player to play again.
   
Game restart should include: 
  - choosing another random word
  - Wins/Losses should be adjusted accordingly
  - Resetting Number of Guesses Remaining
...
> Request: Make a game in which the app randomly picks a letter and the user has to guess which letter the app chose.
...
```
For usability, the user should not have a click a button to guess a letter. Typing the letter should be good enough.
```

### Bonus

- Choose a theme and make it stylish
- For responsive mobility - The user doesn't have a keyboard, how do you make it work on a mobile phone?
...
4. Try your best to deliver a 'working/playable game' by the end of the deadline. If you're not making progress with the recommended assignment, switch gears to the easier assignment. Contact your TA/Instructor if you're not making progress after 2 hours. We're here to help!
